...
- `methodology/`: data contract, feature engineering, econometric methods,
  attribution methods, and interpretation guardrails.
- `architecture/`: repository structure, pipeline design, and reproducibility.
