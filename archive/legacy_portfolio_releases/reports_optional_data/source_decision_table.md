...
| SEC / public ETF filings | Primary-source dates and language for ETF approvals, listings, and fund documents. | Low with the numeric panel; useful for event-study documentation and date audits. | No paid key required for public filings; automated access should respect SEC fair-access guidance. | Low | Optional documentation/audit source, not a numeric core data dependency. |
