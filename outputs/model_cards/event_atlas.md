# Cycle and event atlas Model Card

## Purpose and research question

Describe configured event-window outcomes with dependence-aware placebo context.
...
Do not infer causality from event timing.
